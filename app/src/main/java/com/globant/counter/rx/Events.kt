...
object EventTypes {
    ...
    const val MULTIPLICATION_VALUE_EVENT = 5
    const val DIVISION_VALUE_EVENT = 6
    ...
    const val THREE_VALUE_EVENT = 13
    const val FOUR_VALUE_EVENT = 14
    const val FIVE_VALUE_EVENT = 15
    const val SIX_VALUE_EVENT = 16
